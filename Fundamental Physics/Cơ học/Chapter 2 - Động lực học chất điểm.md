...
## II. Hệ quy chiếu Galile và hệ quy chiếu phi Galile
### 1. Hệ quy chiếu Galile
#### A. định nghĩa
- Là hệ quy chiếu nghiệm đúng các định luật Newton
- Hệ quy chiếu Trái Đất $R_T$ , gắn với mặt đất, có thể gọi là hệ quy chiếu Galile.
#### b. Lớp các hệ quy chiếu galile
### 2. Hệ quy chiếu phi Galile
- Một hệ quy chiếu có gia tốc đối với hệ quy chiếu Galile không phải là hệ quy chiếu Galile (hay còn gọi là hệ quy chiếu phi quan tính)
### III. Các loại lực cơ học
#### 1. Lực trọng trường (Trọng lực)
##### a. Tương tác hấp dẫn
$$\begin{align}&\overrightarrow{F}_{M_1 \rightarrow M_2}=-G\frac{m_1m_2}{r^2}\overrightarrow{e}_{12}\\\text{with} &\; G=6,672.10^{-11}\;N.m^2kg^{-2}\end{align}$$
![[Pasted image 20220410190043.png|center]]

##### b. Trọng lực Trái Đất
$$\begin{align}&\overrightarrow{P}=m.\overrightarrow{g}\quad\rightarrow \overrightarrow{g}=-G\frac{M_T}{R_T^2}.\overrightarrow{e_r}\\\text{with}\;&g=9,8\;m/s^2\end{align}$$
#### 2. Lực căng sợi dây
##### a.  Định nghĩa
![[Pasted image 20220410190305.png]]
$$\begin{align}&\overrightarrow{F}_{S_1 \to S_2}=-T.\overrightarrow{t}_{12}\\\text{or}\;&\overrightarrow{F}_{S_2 \to S_1}=T.\overrightarrow{t}_{12}\end{align}$$
với $T$ là lực căng của dây tại P
##### b. Trường hợp sợi dây lý tưởng
- Khối lượng sợi dây không đáng kể
- Lực căng của dây là đồng đều
##### c. Ròng rọc lý tưởng
- Bỏ qua mô men quán tính của nó với trục quay (bỏ qua khối lượng)
![[Pasted image 20220410190803.png]]
#### 3. Lực đàn hồi
##### a. Lò xo lý tưởng
$$\begin{align} &T = k(l-l_0)\\\text{với}\; &k \; \text{là độ cứng lò xo} \end{align}$$
![[Pasted image 20220410191111.png]]
$$\overrightarrow{F}=T\overrightarrow{u}x, \;T=k(l-l_0), \;l>l_0$$
##### b. Liên kết lò xo thành dãy
![[Pasted image 20220410191346.png]]
$$\frac{1}{k}=\frac{1}{k_1}+\frac{1}{k_2}$$
#### 4. lực ma sát trong một chất lưu
- Trong chuyển động với vận tốc nhỏ: $\overrightarrow{F}_{frot} \sim -\overrightarrow{v}$
- Trong chuyển động với vận tốc lớn: $\overrightarrow{F}_{frot} \sim v^2$ 
-  ![[Pasted image 20220410191944.png]]
$$\overrightarrow{F}_{frot}=-k.s.v^2.\overrightarrow{T}\quad(\overrightarrow{v}=v.\overrightarrow{T})$$
#### 5. Các Lực liên kết
##### a. Sự tồn tại các liên kết
##### b. Phản lực của giá đỡ
$$\overrightarrow{F}_{S\to M}=\overrightarrow{R}$$
![[Pasted image 20220410192316.png]]
##### c. Liên kết một bên
$$\overrightarrow{R}.\overrightarrow{n}\geq 0\quad \quad \overrightarrow{R} \; \text{là phản lực}$$
