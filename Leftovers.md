...
| Model       | Key Feat                                                                                                                               | Strengths                                                                                                    | Weaknesses                                                                                                 | Suitability                                          |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
...
| Agile       | - Iterative, time-boxed sprints  <br>- Continuous feedback and delivery  <br>- Emphasizes customer collaboration and adaptive planning | - Highly flexible  <br>- Rapid delivery of useful software  <br>- Encourages collaboration and communication | - Needs active user involvement <br>- Harder to predict effort and cost  <br>- Can lead to scope creep     |                                                      |
