...
| V-Model     | - Waterfall, but with corresponding testing/ development phase<br>-High emphasis on validation                 | - High quality assurance<br>- Early detection of defects<br>- Clear deliverable phases                | - Extremely rigid<br>- Very expensive to fix changes<br>- Not flexible for iterative feedbac               | - Safety-critical projects(h)                    |
